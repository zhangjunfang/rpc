...
/*
GoroutineExtendedWorker - An optional interface that can be implemented if the worker needs
...
/*
GoroutineInterruptable - An optional interface that can be implemented in order to allow the
